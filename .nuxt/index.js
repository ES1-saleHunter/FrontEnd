...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"sale-hunter","htmlAttrs":{"lang":"en"},"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""},{"name":"format-detection","content":"telephone=no"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002F"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_maskplugin_7e3f8a80 === 'function') {
    await nuxt_plugin_maskplugin_7e3f8a80(app.context, inject)
  }

  if (typeof nuxt_plugin_iconpark_4aeae94a === 'function') {
    await nuxt_plugin_iconpark_4aeae94a(app.context, inject)
  }
